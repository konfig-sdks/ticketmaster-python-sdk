...
from ticketmaster_python_sdk.model.event_images import EventImages as EventImagesSchema

from ticketmaster_python_sdk.type.event_images import EventImages

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.event_images import EventImages as EventImagesPydantic
...
SchemaFor200ResponseBody = EventImagesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_event_images_mapped_args(
        self,
        id: str,
    ...
    async def _aget_event_images_oapg(
        self,
...
class GetEventImagesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_event_images(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_event_images_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_event_images_oapg(
    ...
    def get_event_images(
        ...
        return self._get_event_images_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetEventImages(BaseApi):
    ...
    async def aget_event_images(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_event_images(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
        ...
        if validate:
            return EventImagesPydantic(**raw_response.body)
        return api_client.construct_model_instance(EventImagesPydantic, raw_response.body)
    ...
    def get_event_images(
        ...
        raw_response = self.raw.get_event_images(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
