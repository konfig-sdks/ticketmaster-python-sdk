...
from ticketmaster_python_sdk.model.attraction import Attraction as AttractionSchema

from ticketmaster_python_sdk.type.attraction import Attraction

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.attraction import Attraction as AttractionPydantic
...
SchemaFor200ResponseBody = AttractionSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_attraction_details_mapped_args(
        self,
        id: str,
    ...
    async def _aget_attraction_details_oapg(
        self,
    ...
    def _get_attraction_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAttractionDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_attraction_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_attraction_details_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_attraction_details_oapg(
    ...
    def get_attraction_details(
        ...
        return self._get_attraction_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAttractionDetails(BaseApi):
    ...
    async def aget_attraction_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_attraction_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
        ...
        if validate:
            return AttractionPydantic(**raw_response.body)
        return api_client.construct_model_instance(AttractionPydantic, raw_response.body)
    ...
    def get_attraction_details(
        ...
        raw_response = self.raw.get_attraction_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
