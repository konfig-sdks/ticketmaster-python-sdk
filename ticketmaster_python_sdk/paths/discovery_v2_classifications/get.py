...
from ticketmaster_python_sdk.model.v2_search_classifications_response import V2SearchClassificationsResponse as V2SearchClassificationsResponseSchema

from ticketmaster_python_sdk.type.v2_search_classifications_response import V2SearchClassificationsResponse

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.v2_search_classifications_response import V2SearchClassificationsResponse as V2SearchClassificationsResponsePydantic
...
SchemaFor200ResponseBody = V2SearchClassificationsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: V2SearchClassificationsResponse
...
class BaseApi(api_client.Api):
    ...
    def _search_classifications_mapped_args(
        self,
    ...
    async def _asearch_classifications_oapg(
        self,
    ...
    def _search_classifications_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SearchClassificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_classifications(
        self,
        sort: typing.Optional[str] = None,
        keyword: typing.Optional[str] = None,
        id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._search_classifications_mapped_args(
            sort=sort,
            keyword=keyword,
            id=id,
            source=source,
        ...
        return await self._asearch_classifications_oapg(
    ...
    def search_classifications(
        ...
        return self._search_classifications_oapg(
            query_params=args.query,
        )

class SearchClassifications(BaseApi):
    ...
    async def asearch_classifications(
        ...
        validate: bool = False,
        **kwargs,
    ) -> V2SearchClassificationsResponsePydantic:
        raw_response = await self.raw.asearch_classifications(
            sort=sort,
            keyword=keyword,
            id=id,
            source=source,
        ...
        if validate:
            return RootModel[V2SearchClassificationsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(V2SearchClassificationsResponsePydantic, raw_response.body)
    ...
    def search_classifications(
        ...
        raw_response = self.raw.search_classifications(
            sort=sort,
            keyword=keyword,
            id=id,
            source=source,
