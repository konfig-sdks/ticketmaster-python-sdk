...
from ticketmaster_python_sdk.model.event import Event as EventSchema

from ticketmaster_python_sdk.type.event import Event

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.event import Event as EventPydantic
...
SchemaFor200ResponseBody = EventSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_event_details_mapped_args(
        self,
        id: str,
    ...
    async def _aget_event_details_oapg(
        self,
...
class GetEventDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_event_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_event_details_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_event_details_oapg(
    ...
    def get_event_details(
        ...
        return self._get_event_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetEventDetails(BaseApi):
    ...
    async def aget_event_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_event_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
    ...
    def get_event_details(
        ...
        raw_response = self.raw.get_event_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
