...
from ticketmaster_python_sdk.model.level import Level as LevelSchema

from ticketmaster_python_sdk.type.level import Level

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.level import Level as LevelPydantic
...
SchemaFor200ResponseBody = LevelSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_subgenre_details_mapped_args(
        self,
        id: str,
    ...
    async def _aget_subgenre_details_oapg(
        self,
    ...
    def _get_subgenre_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSubgenreDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_subgenre_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_subgenre_details_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_subgenre_details_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_subgenre_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        ...
        return self._get_subgenre_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSubgenreDetails(BaseApi):
    ...
    async def aget_subgenre_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_subgenre_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
        ...
        if validate:
            return LevelPydantic(**raw_response.body)
        return api_client.construct_model_instance(LevelPydantic, raw_response.body)
    ...
    def get_subgenre_details(
        ...
        raw_response = self.raw.get_subgenre_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
