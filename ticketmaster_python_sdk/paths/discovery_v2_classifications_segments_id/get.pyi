...
from ticketmaster_python_sdk.model.segment import Segment as SegmentSchema

from ticketmaster_python_sdk.type.segment import Segment

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.segment import Segment as SegmentPydantic
...
SchemaFor200ResponseBody = SegmentSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_segment_details_mapped_args(
        self,
        id: str,
    ...
    async def _aget_segment_details_oapg(
        self,
...
class GetSegmentDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_segment_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_segment_details_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_segment_details_oapg(
    ...
    def get_segment_details(
        ...
        return self._get_segment_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSegmentDetails(BaseApi):
    ...
    async def aget_segment_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_segment_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
    ...
    def get_segment_details(
        ...
        raw_response = self.raw.get_segment_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
