...
from ticketmaster_python_sdk.model.genre import Genre as GenreSchema

from ticketmaster_python_sdk.type.genre import Genre

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.genre import Genre as GenrePydantic
...
SchemaFor200ResponseBody = GenreSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_genre_details_mapped_args(
        self,
        id: str,
    ...
    async def _aget_genre_details_oapg(
        self,
...
class GetGenreDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_genre_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_genre_details_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_genre_details_oapg(
    ...
    def get_genre_details(
        ...
        return self._get_genre_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetGenreDetails(BaseApi):
    ...
    async def aget_genre_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_genre_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
        ...
        if validate:
            return GenrePydantic(**raw_response.body)
        return api_client.construct_model_instance(GenrePydantic, raw_response.body)
    ...
    def get_genre_details(
        ...
        raw_response = self.raw.get_genre_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
