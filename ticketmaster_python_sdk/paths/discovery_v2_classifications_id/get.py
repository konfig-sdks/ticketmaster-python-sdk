...
from ticketmaster_python_sdk.model.classification import Classification as ClassificationSchema

from ticketmaster_python_sdk.type.classification import Classification

from ...api_client import Dictionary
from ticketmaster_python_sdk.pydantic.classification import Classification as ClassificationPydantic
...
SchemaFor200ResponseBody = ClassificationSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_classification_details_mapped_args(
        self,
        id: str,
    ...
    async def _aget_classification_details_oapg(
        self,
    ...
    def _get_classification_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetClassificationDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_classification_details(
        self,
        id: str,
        locale: typing.Optional[str] = None,
        include_licensed_content: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_classification_details_mapped_args(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
        return await self._aget_classification_details_oapg(
    ...
    def get_classification_details(
        ...
        return self._get_classification_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetClassificationDetails(BaseApi):
    ...
    async def aget_classification_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_classification_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
            **kwargs,
    ...
    def get_classification_details(
        ...
        raw_response = self.raw.get_classification_details(
            id=id,
            locale=locale,
            include_licensed_content=include_licensed_content,
        )
